  ...
  return (
    <main className="min-h-screen bg-white dark:bg-slate-900 py-16 px-4 text-gray-900 dark:text-white">
              ...
              <section key={category}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {members.map((member, idx) => (
                    ...
                    >
                      <div
                        className="h-64 flex items-center justify-center bg-gray-100 dark:bg-slate-700 cursor-pointer"
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-primary dark:text-amber-300 font-semibold text-sm">
                          {member.role}
                        </p>
                      </div>
                    </div>
      ...
      {selectedMember && (
        ...
        >
          <div
            className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-2xl max-w-md w-full relative"
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              <img
                src={selectedMember.profileImage || '/avatar.png'}
                className="w-32 h-32 rounded-full object-cover border mb-5"
              />
              ...
              <p className="text-lg font-semibold mb-5 text-primary dark:text-amber-300">
                {selectedMember.role}
              </p>
